...
|------|-------|
| Version | v0.8.23 |
| Milestone | M36 - REST Framework |
| Build Date | 7 August 2026 |
| Status | Phase 5 Completed; M36 verified locally |
...
- REST framework controllers, typed parameter binding, response serialization, RFC 7807 ProblemDetails, and OpenAPI 3.0 specification generation
- Request-scoped DI lifetime, handler dependency injection, automatic scope disposal, and concurrent request isolation
- REST framework controllers, typed parameter binding, response serialization, RFC 7807 ProblemDetails, and OpenAPI 3.0 specification generation
- Request-scoped DI lifetime, handler dependency injection, automatic scope disposal, and concurrent request isolation
- REST framework controllers, typed parameter binding, response serialization, RFC 7807 ProblemDetails, and OpenAPI 3.0 specification generation
